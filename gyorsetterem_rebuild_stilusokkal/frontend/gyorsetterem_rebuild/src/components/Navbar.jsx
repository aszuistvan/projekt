...
function Navbar() {
    const {bejelentkezett} = useContext(FelhasznaloContext);

    if(bejelentkezett){
        return (
            <div className="navbar bg-base-200 flex justify-center items-center h-10 fixed w-full top-0 z-50">
                <div className="flex-none flex justify-center items-center">
                <Link to ="/"><img src={logo} alt="Logo" className="h-24 object-contain" /></Link>
                </div>
                    ...
                    <ul className="menu menu-horizontal px-1 text-center lg:text-left items-end customLinkContainer"> 
                        ...
                        <li className="lg:hidden dropdown dropdown-end dropdown-hover"> {/* Set background color here */}
                            ...
                            <ul className="dropdown-content">
                                ...
                                <li className="bg-base-200"><Link to={'/regisztracio'} className="customLink mx-1">Kosár</Link></li>
                                <li className="bg-base-200"><Link to={'/bejelentkezes'} className="customLink mx-1">Profilod</Link></li>
                            </ul>
                        </li>
                        ...
                        <li className="hidden lg:block"><Link to={'/regisztracio'} className="customLink mx-1">Kosár</Link></li>
                        <li className="hidden lg:block"><Link to={'/bejelentkezes'} className="customLink mx-1">Profilod</Link></li>
